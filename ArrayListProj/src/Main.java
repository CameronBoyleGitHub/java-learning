...
public class Main {
    ...
    private static MobilePhone mobilePhone = new MobilePhone("666 666 6666");
    public static void main(String[] args) {
        boolean quit = false;
        startPhone();
        printActions();
        while(!quit) {
            System.out.println("\nEnter action: (Press 6 for all available options)");
    ...
    private static void queryContact() {
        ...
        Contact existingContactRecord = mobilePhone.queryContact(contact);
